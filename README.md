...
Ensure you have a WRDS account (XJTLU students can apply).
Place industry_benchmarks.csv in the root folder (already included).
...
GitHub Repository: https://github.com/wendyhoo-creator/ACC102_Financial_Health
